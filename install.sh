...
ORIGIN_PATH="$PWD"
LUM_ENV=$([ "$1" == "dev" ] && echo "--server=https://luarocks.org/dev" || echo "")
...
error_exit "luarocks install $LUM_ENV lummander" "Could't install dependencies. Is it installed Luarocks?"
